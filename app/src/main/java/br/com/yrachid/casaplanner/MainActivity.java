...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView alugueisListView = (ListView) findViewById(R.id.alugeis_list_view);
        ...
        try {
            ...
            for (int i=0; i<imoveis.size(); i++) {
                imoveisEmString[i] = imoveis.get(i).toString();
            }

            ArrayAdapter adapter = new ArrayAdapter(this, android.R.layout.simple_list_item_1, imoveisEmString);
            alugueisListView.setAdapter(adapter);
